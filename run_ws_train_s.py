...
def main():
    ...
    assert processor.tokenizer.vocab_size == model.config.vocab_size,f"vocab_size of model is {model.config.vocab_size}, but vocab_size of model is {processor.tokenizer.vocab_size}"
    ...
    ignored_columns = list(set(train_dataset.column_names) - set(["file", "labels", "length", "seg_start", "seg_end"]))
