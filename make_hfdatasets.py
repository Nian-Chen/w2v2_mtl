...
if __name__ == "__main__":
    ...
    parser.add_argument("-maxl", "--max_length", type=str, default=15.0, help="filter by max_length of audio")
    parser.add_argument("-minl", "--min_length", type=str, default=0.2, help="filter by min_length of audio")
    ...
    def map2segfile(batch):
        ...
        batch["file"] = trim_audio_dir+"/"+batch["id"]+".flac"
        return batch
